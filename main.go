...
func main() {
	...
	// pet.disabled keeps packs out of the pickers; Library.Hide carries the
	// two guards that go with it, and the reload path applies the same ones.
	if lib.Hide(cfg.Pet.Disabled, cfg.Pet.Active) {
